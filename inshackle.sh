...
printf "      \e[1;31m[\e[0m\e[1;77mv1.0\e[0m\e[1;31m]\e[0m\e[1;77m INSTAGRAM BOT\e[0m\n"
}
...
xdg-open https://api.whatsapp.com/send?phone=62895332579555
sleep 1
clear
open
...
open() {
printf "\n";
printf "tanya kepada mr.lil_dwagz untuk codenya\nJika tidak tahu";
printf "\n";
printf "1.tahu\n";
printf "2.tidak tahu";
printf "\n";

read -p $"your option : " masukan;

if [[ $masukan -eq 1 ]]; then
reset
bka
